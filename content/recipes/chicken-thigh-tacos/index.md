---
title: Chicken Thigh Tacos
date: 2025-12-19T14:46:47-07:00
summary: |-
...
author:
  name: Laura Fuentes
  url: https://www.laurafuentes.com/about-laura-fuentes/
# Recipe taxonomies
cuisines: [Mexican]    # e.g., ["Italian"], ["Thai", "Asian"]
categories: [Main course]
diets: []       # e.g., ["Vegetarian"], ["Vegan", "Gluten-Free"]
# Recipe metadata
prepTime: "PT15M"    # ISO8601 duration: PT15M = 15 minutes
cookTime: "PT20M"    # PT30M = 30 minutes, PT1H = 1 hour
totalTime: "PT60M"   # PT45M = 45 minutes
yield: 6
yieldUnit: "servings"
difficulty: "Easy"   # Easy, Intermediate, Advanced
---

The [original recipe](https://www.laurafuentes.com/chicken-thigh-tacos/) has good suggestions for toppings.
...
**Marinade chicken:** In a zip bag or marinating bowl, combine the chipotle peppers in adobo sauce, 1 teaspoon cumin, and the juice of 1 lime.
The marinade will be discarded afterward.
Marinate the chicken thighs for 15 to 20 minutes or overnight in the fridge.

**Cook and rest:** Heat a large pan over medium-high heat.
...
**Tips:** These go very well with finely diced red onion and chopped cilantro.
And [crema](https://downshiftology.com/recipes/lime-crema/)!
