---
title: Carne Asada
date: 2025-12-19T08:25:50-07:00
summary: |-
  Using ranchero (flap steak) is the way to go for this grilled beef.
  I cooked this on a flat top---plancha, big cast iron surface---rather than grilled then sliced thin across the grain for tacos.
draft: false
images: [steaks.png]
# Recipe author (for structured data)
author:
  name: Brooke Caison
  url: https://www.delish.com/author/229187/brooke-caison/ (optional)
# Recipe taxonomies
cuisines: [Mexican]
categories: [Tacos, Buffet]
diets: []       # e.g., ["Vegetarian"], ["Vegan", "Gluten-Free"]
# Recipe metadata
prepTime: "PT15M"    # ISO8601 duration: PT15M = 15 minutes
cookTime: "PT10M"    # PT30M = 30 minutes, PT1H = 1 hour
totalTime: "PT4H30M"   # PT45M = 45 minutes
yield: 6
yieldUnit: "servings"
...
![Steaks on a plancha](steaks.png)
