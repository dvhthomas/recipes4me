...
date: 2025-12-19T11:11:28-07:00
summary: |-
  After many attempts using different recipes, my daughter captured the taste of a classic English currant scone using a great recipe from [Fifteen Spatulas](https://www.fifteenspatulas.com/about/).
  These are circular rather than the typical USA triangular wedge. A double recipe is recommended.
draft: false
images: [scones.png]
# Recipe author (for structured data)
author:
  name: Joanne Ozug           # Recipe author's name
  url: https://www.fifteenspatulas.com/about/
# Recipe taxonomies
cuisines: [English]
categories: [Dessert, Pastry, Baking]
diets: []
# Recipe metadata
prepTime: "PT15M"
cookTime: "PT15M"
...
![Scones on a dish with jam and clotted cream](scones.png)
{{< recipe >}}
