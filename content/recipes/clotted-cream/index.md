...
author:
  name: Sue Moran           # Recipe author's name
  url: https://theviewfromgreatisland.com/about/
# Recipe taxonomies
cuisines: [British]    # e.g., ["Italian"], ["Thai", "Asian"]
categories: [Dessert, Sauces]  # e.g., ["Dinner"], ["Dessert", "Baking"]
diets: [Vegetarian]
# Recipe metadata
prepTime: "PT0M"    # ISO8601 duration: PT15M = 15 minutes
cookTime: "PT30M"    # PT30M = 30 minutes, PT1H = 1 hour
totalTime: "PT8H"   # PT45M = 45 minutes
yield: 2
yieldUnit: "cups"
...
![clotted cream served in a ceramic bowl](finished.jpg)
...
![chilled clotted cream](chilled.jpg)
{{< /instructions >}}
